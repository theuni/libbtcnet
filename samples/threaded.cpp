...
{
public:
    CConnMan(int max_outgoing) : CThreadedConnManager(max_outgoing){}
private:
...
void CConnMan::ProcessMessage(CThreadedNode*, const std::vector<unsigned char>&)
{
    /* Messages come in here on a separate thread. */
}
